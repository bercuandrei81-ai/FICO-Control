...
<style>
*{{box-sizing:border-box}}
body{{margin:0;min-height:100vh;background:#101820 url('/login-background?v=mr-logistics-station-2') center center/cover no-repeat fixed;font-family:Arial,sans-serif;color:#17212b;position:relative}}
